...
function LoginContent() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-300 ${isDarkMode
      ? 'bg-gray-900'
      ...
      <button
        onClick={toggleTheme}
        className={`absolute top-6 right-6 p-3 rounded-full transition-all duration-200 ${isDarkMode
      ...
      <div className="relative z-10 w-full max-w-md p-6">
        ...
        {/* Login Card */}
        <Card className={`shadow-2xl transition-colors duration-300 ${isDarkMode
          ...
          <CardContent className="p-8">
            {/* General Error Alert */}
            {errors.general && (
              <Alert variant="destructive" className={`mb-6 ${isDarkMode
            ...
            {resetEmailSent && (
              <Alert className={`mb-6 ${isDarkMode
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className={`absolute left-3 top-3 h-5 w-5 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                    }`} />
                  <Input
                    id="email"
                    type="email"
                    placeholder="Enter your email"
                    className={`pl-11 h-12 transition-all duration-200 ${isDarkMode
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-11 pr-11 h-12 transition-all duration-200 ${isDarkMode
                  ...
                  <button
                    ...
                    className={`absolute right-3 top-3 transition-colors ${isDarkMode
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm uppercase">
                <span className={`px-4 font-medium ${isDarkMode
            ...
            <Button
              variant="outline"
              className={`w-full h-12 font-semibold text-base transition-all duration-200 ${isDarkMode
            ...
            <div className="mt-8 text-center">
              ...
              <Link
                href="/signup"
                className={`font-semibold transition-colors focus:outline-none focus:underline ${isDarkMode
                  ? 'text-orange-400 hover:text-orange-300'
                  : 'text-orange-600 hover:text-orange-500'
                  }`}
              >
        ...
        <div className="text-center mt-8">
          <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>
            ...
            <Link href="/terms" className={`transition-colors ${isDarkMode
            ...
            {' '}and{' '}
            <Link href="/privacy" className={`transition-colors ${isDarkMode
              ? 'text-gray-400 hover:text-orange-400'
              : 'text-gray-500 hover:text-orange-600'
              }`}>
              Privacy Policy
